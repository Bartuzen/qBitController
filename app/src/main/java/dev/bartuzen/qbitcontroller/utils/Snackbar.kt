...
fun Activity.showSnackbar(
    text: String, @BaseTransientBottomBar.Duration length: Int = Snackbar.LENGTH_LONG
) {
    Snackbar.make(findViewById(android.R.id.content), text, length).show()
}

fun Activity.showSnackbar(
    @StringRes resId: Int, @BaseTransientBottomBar.Duration length: Int = Snackbar.LENGTH_LONG
) {
