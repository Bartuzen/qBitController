...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                Preference(
                    title = { Text(text = stringResource(R.string.settings_category_servers)) },
                    icon = {
                        Icon(
            ...
            item {
                Preference(
                    title = { Text(text = stringResource(R.string.settings_category_appearance)) },
                    icon = {
                        Icon(
            ...
            item {
                Preference(
                    title = { Text(text = stringResource(R.string.settings_category_network)) },
                    icon = {
                        Icon(
