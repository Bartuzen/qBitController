package dev.bartuzen.qbitcontroller.ui.di
...
val appModule = module {
    ...
    viewModel { (serverId: Int, hash: String) -> TorrentOverviewViewModel(serverId, hash, get(), get(), get(), get()) }
    ...
    viewModel { (serverId: Int, hash: String) -> TorrentPeersViewModel(serverId, hash, get(), get(), get(), get(), get()) }
